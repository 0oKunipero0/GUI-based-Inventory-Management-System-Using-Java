...
/**This class is used to implement controller for the ModifyProduct form. */
public class ModifyProductController implements Initializable {

    /**
     * the product object that's being selected for modification. 
     */
    ...
    /**
     * Parts Table View in the ModifyProduct form. 
     */
    @FXML
    ...
    /**
     * Associated Parts Table View in the ModifyProduct form. 
     */
    @FXML
    ...
    /**This method is used to update a Product object by saving the modified field texts and associated parts. */
    @FXML
    void saveAction(ActionEvent event) throws IOException {
        ...
        try {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error");
            alert.setHeaderText("Error - Failed to Modify Product");
    ...
    /** This is used to display  both the part and associate part tables in the AddProduct form, and to modify existing products using the new entries entered. 
     * This is used to display  both the part and associate part tables in the AddProduct form, and to modify existing products using the new entries entered. 
     * @param location
     * @param resources
     */
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        idOfProTxt.setText(String.valueOf(selectedProduct.getId()));
        nameOfProTxt.setText(selectedProduct.getName());
        invOfProTxt.setText(String.valueOf(selectedProduct.getStock()));
        priceOfProTxt.setText(String.valueOf(selectedProduct.getPrice()));
        maxStockOfProTxt.setText(String.valueOf(selectedProduct.getMax()));
        minStockOfProTxt.setText(String.valueOf(selectedProduct.getMin()));
    }
}
